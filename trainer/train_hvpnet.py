...
class RETrainer(BaseTrainer):
        ...
        with torch.no_grad():
            with tqdm(total=len(self.dev_data), leave=False, dynamic_ncols=True) as pbar:
                ...
                for batch in self.dev_data:
                    ...
                    true_labels.extend(labels.detach().cpu().tolist())  # 每行为多标签
                ...
                acc, micro_f1 = round(acc*100, 4), round(micro_f1*100, 4)
                if self.writer:
                ...
                self.logger.info("Epoch {}/{}, best dev f1: {}, best epoch: {}, current dev f1 score: {}, acc: {}, pre:{}, recall:{}."\
                            .format(epoch, self.args.num_epochs, self.best_dev_metric, self.best_dev_epoch, micro_f1, acc, precision, recall))
    ...
    def _step(self, batch, mode="train"):
        if mode != "predict":
            ...
            outputs = self.model(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids, labels=labels, images=images)
